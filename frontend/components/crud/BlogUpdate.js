        ...
        return (
            categories && categories.map((c, i) => (
                ...
                <li key={i} className="list-unstyled">
                    <input onChange={handleToggle(c._id)} type="checkbox" className="ms-2" checked = {findOutCategory(c._id)}></input>
    ...
    const showTags = () => {
        ...
        return (
            tags && tags.map((t, i) => (
                ...
                <li key={i} className="list-unstyled">
                    <input onChange={handleTagsToggle(t._id)} type="checkbox" className="ms-2" checked = {findOutTag(t._id)}></input>
        ...
        <div className="container-fluid pb-5">
             <div className="row">
                <div className="col-md-8">
                   ...
                   {body && <img src= {`${API}/blog/photo/${router.query.slug}`} alt = {title} style = {{width : '100%'}}></img>}
                </div>
